...
void menu(Graphe g)
{
    ...
    do
    {
        ...
        if(choix==1)
        {
            int choixAction;
            system("cls");
            std::cout<<"Veuillez choisir votre action"<<std::endl<<"1) Calculer l'indice de Degre"<<std::endl<<"2) Calculer l'indice de Vecteur Propre"<<std::endl<<"3) Calculer l'indice de Proximite"<<std::endl<<"4) Calculer l'indice d'intermediarite"<<std::endl<<"5) Calculer la vulnerabilite"<<std::endl;
            std::cin>>choixAction;
            switch(choixAction)
            {
            case 1:
