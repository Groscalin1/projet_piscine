...
Graphe::Graphe(std::string nomFichier)
{
    ...
    {
        ifs >> id1 >> nom >> x >> y;
        m_ListeSommets.push_back(Sommet(id1,nom,x*100,y*100));
    }
    ...
    for (int i=0; i<taille; ++i)
    {
        ...
        if(orientation==1)
        {
            m_ListeAretes.push_back(Arete(id3,m_ListeSommets[id1],m_ListeSommets[id2]));
            m_ListeSommets[id1].ajouterAdjacents();
        }
        if(orientation==0)
        {
            ///PREMIER SENS
            ...
            ///DEUXIEME SENS
            id3+=taille;
            m_ListeAretes.push_back(Arete(id3,m_ListeSommets[id2],m_ListeSommets[id1]));
            m_ListeSommets[id2].ajouterAdjacents();
        }
        else
